...
import DataEntry from './pages/admin/tools/DataEntry'; // ✅ NEW
      ...
      <BrowserRouter>
        <Layout>
          <Routes>
            ...
            <Route path="/admin/tools/data-entry" element={<ProtectedRoute role="admin"><DataEntry /></ProtectedRoute>} />
